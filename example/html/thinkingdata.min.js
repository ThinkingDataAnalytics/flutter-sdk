! function () {
    ...
    "object" !== ("undefined" == typeof JSON ? "undefined" : _typeof(JSON)) && (JSON = {}), ! function () {
        ...
        "function" != typeof Date.prototype.toJSON && (Date.prototype.toJSON = function () {
            ...
            if (!(rep = t) || "function" == typeof t || "object" === _typeof(t) && "number" == typeof t.length) return str("", {
                "": e
            });
    ...
    var Config = {
        ...
        _ = {
            ...
            formatDate: function (e) {
                ...
                return e.getFullYear() + "-" + t(e.getMonth() + 1) + "-" + t(e.getDate()) + " " + t(e.getHours()) + ":" + t(e.getMinutes()) + ":" + t(e.getSeconds()) + "." + ((e = e.getMilliseconds()) < 10 ? "00" + e : e < 100 ? "0" + e : e)
            },
            formatTimeZone: function (e, t) {
                var r;
                return "number" != typeof t ? e : (r = e.getTime(), e = 6e4 * e.getTimezoneOffset(), new Date(r + e + 36e5 * t))
            },
            ...
            searchObjDate: function (r, n) {
                (_.check.isObject(r) || _.check.isArray(r)) && _.each(r, function (e, t) {
                    _.check.isObject(e) || _.check.isArray(e) ? _.searchObjDate(r[t], n) : _.check.isDate(e) && (r[t] = _.formatDate(_.formatTimeZone(e, n)))
                })
            },
            check: {
        ...
        Log = (_.UUID = function () {
            ...
            return function () {
                var e = (e = String(screen.height * screen.width)) && /\d{5,}/.test(e) ? e.toString(16) : String(31242 * Math.random()).replace(".", "").slice(0, 8),
                    e = t() + "-" + Math.random().toString(16).replace(".", "") + "-" + function () {
            ...
            return "string" != typeof e ? "referrer exception" + String(e) : "string" == typeof (e = (e = 0 === e.indexOf("https://www.baidu.com/") ? e.split("?")[0] : e).slice(0, MAX_REFERRER_STRING_LENGTH)) ? e : ""
        }, _.url = function () {
            function i() {
            ...
            function s(e, t) {
                for (var r, n = e.charAt(0), i = t.split("&"), o = [], s = {}, a = e.substring(1), c = 0, u = i.length; c < u; c++)
                    if ("" !== (o = (o = i[c].match(/(.*?)=(.*)/)) || [i[c], i[c], ""])[1].replace(/\s/g, "")) {
                        if (o[2] = (r = o[2] || "", _.decodeURIComponent(r.replace(/\+/g, " "))), a === o[1]) return o[2];
                        (r = o[1].match(/(.*)\[([0-9]+)\]/)) ? (s[r[1]] = s[r[1]] || [], s[r[1]][r[2]] = o[2]) : s[o[1]] = o[2]
                    } return n === e ? s : s[a]
            }
            return function (e, t) {
                var r, n = {};
                ...
                if (e = e.toString(), r = t.match(/^mailto:([^\/].+)/)) n.protocol = "mailto", n.email = r[1];
                    ...
                    if ((r = (t = (r = t.match(/(.*?)\/#\!(.*)/)) ? r[1] + r[2] : t).match(/(.*?)#(.*)/)) && (n.hash = r[2], t = r[1]), n.hash && e.match(/^#/)) return s(e, n.hash);
                    if ((r = t.match(/(.*?)\?(.*)/)) && (n.query = r[2], t = r[1]), n.query && e.match(/^\?/)) return s(e, n.query);
                    if ((r = t.match(/(.*?)\:?\/\/(.*)/)) && (n.protocol = r[1].toLowerCase(), t = r[2]), (r = t.match(/(.*?)(\/.*)/)) && (n.path = r[2], t = r[1]), n.path = (n.path || "").replace(/^([^\/])/, "/$1").replace(/\/$/, ""), (e = e.match(/^[\-0-9]+$/) ? e.replace(/^([^\/])/, "/$1") : e).match(/^\//)) return o(e, n.path.substring(1));
                    if ((r = (r = o("/-1", n.path.substring(1))) && r.match(/(.*?)\.(.*)/)) && (n.file = r[0], n.filename = r[1], n.fileext = r[2]), (r = t.match(/(.*)\:([0-9]+)$/)) && (n.port = r[2], t = r[1]), (r = t.match(/(.*?)@(.*)/)) && (n.auth = r[1], t = r[2]), n.auth && (r = n.auth.match(/(.*)\:(.*)/), n.user = r ? r[1] : n.auth, n.pass = r ? r[2] : void 0), n.hostname = t.toLowerCase(), "." === e.charAt(0)) return o(e, n.hostname);
                    i() && (r = n.hostname.match(i())) && (n.tld = r[3], n.domain = r[2] ? r[2] + "." + r[3] : void 0, n.sub = r[1] || void 0);
                    t = n.port ? ":" + n.port : "";
                    n.protocol = n.protocol || window.location.protocol.replace(":", ""), n.port = n.port || ("https" === n.protocol ? "443" : "80"), n.protocol = n.protocol || ("443" === n.port ? "https" : "http"), n.basic = n.protocol + "://" + n.hostname + t
                }
            ...
            var t, r, n, i, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
                ...
                u = [];
            if (!e) return e;
            for (e = _.utf8Encode(e); t = (i = e.charCodeAt(s++) << 16 | e.charCodeAt(s++) << 8 | e.charCodeAt(s++)) >> 12 & 63, r = i >> 6 & 63, n = 63 & i, u[a++] = o.charAt(i >> 18 & 63) + o.charAt(t) + o.charAt(r) + o.charAt(n), s < e.length;);
            ...
            set: function (e, t, r, n, i) {
                var o = "",
                    s = "",
                    a = "",
                    r = (r = null === r ? 73e3 : r, n && (o = (n = _.url("domain", location.href)) ? "; domain=." + n : ""), r && (n = new Date, "s" === String(r).slice(-1) ? n.setTime(n.getTime() + 1e3 * Number(String(r).slice(0, -1))) : n.setTime(n.getTime() + 24 * r * 60 * 60 * 1e3), s = "; expires=" + n.toGMTString()), i && (a = "; secure"), e + "=" + encodeURIComponent(t) + s + "; path=/" + o + a);
            ...
            return null === t || t && "string" != typeof t[1] && t[1].length ? "" : _.decodeURIComponent(t[1])
        }, _.createString = function (e) {
            for (var t = e, r = Math.random().toString(36).substr(2); r.length < t;) r += Math.random().toString(36).substr(2);
            ...
            if (void 0 !== t) {
                var r = t.publicKey,
                    t = t.version;
                if (void 0 !== r && void 0 !== t && "undefined" != typeof CryptoJS && "undefined" != typeof JSEncrypt) {
                    ...
                    try {
                        ...
                        return !1 === c ? (Log.w("encryption failed"), e) : {
                            pkv: t,
                            ekey: c,
                            payload: s
                        }
            ...
            if (document.addEventListener)
                if ("Array" !== this.paramType(e) && "HTMLCollection" !== this.paramType(e) || !e.length || e === window) e.addEventListener(t, r, n);
                else
                    for (var i = 0; i < e.length; i++) this.addEvent(e[i], t, r, n);
            ...
            h._getPath = function () {
                var e;
                return this.path || this.composedPath && this.composedPath() || (e = this.target, new n(e).getParents())
            };
            var n = function (e) {
                this.ele = e
            };
            ...
            ! function (e, t, r) {
                ...
                }, u) : (i = e[n = "on" + t], e[n] = (o = e, s = r, a = i, c = t, function (e) {
                    var t, r;
                    if (e = e || h(window.event)) return e.target = e.srcElement, t = !0, "function" == typeof a && (r = a(e)), e = s.call(o, e), "beforeunload" !== c ? !1 !== r && !1 !== e && t : void 0
                }))
            }.apply(null, arguments)
        }, _.getURLSearchParams = function (e) {
            for (var t = {}, r = (e = e || "").substring(1).split("&"), n = 0; n < r.length; n++) {
                var i, o = r[n].indexOf("="); - 1 !== o && (i = r[n].substring(0, o), o = r[n].substring(o + 1), i = _.decodeURIComponent(i), o = _.decodeURIComponent(o), t[i] = o)
            }
            return t
            ...
            return t.prototype.setUrl = function (e) {
                ...
                var t, r = this._values.QueryString || "";
                for (t in e) r = new RegExp(t + "[^&]+").test(r) ? r.replace(new RegExp(t + "[^&]+"), t + "=" + e[t]) : "&" === r.slice(-1) ? r + t + "=" + e[t] : "" === r ? t + "=" + e[t] : r + "&" + t + "=" + e[t];
                this._values.QueryString = r
            }, t.prototype.getUrl = function () {
                var e = "";
                return (e += this._values.Origin) + (this._values.Port ? ":" + this._values.Port : "") + this._values.Path + (this._values.QueryString ? "?" + this._values.QueryString : "") + (this._values.Fragment ? "#" + this._values.Fragment : "")
                ...
                for (t in this._fields) void 0 !== n[this._fields[t]] && (this._values[t] = n[this._fields[t]]);
                this._values.Hostname = this._values.Host.replace(/:\d+$/, ""), this._values.Origin = this._values.Protocol + "://" + this._values.Hostname, this._values.Fragment = e
            }, new t(e)
        }, _.trim = function (e) {
            ...
            }()) (n = new URL(e)).searchParams || (n.searchParams = (r = _.getURLSearchParams(n.search), {
                get: function (e) {
                    return r[e]
                }
            }));
            ...
            return _createClass(e, null, [{
                ...
                value: function (e) {
                    return _.check.isObject(e) && _.each(e, function (e, t) {
                        _.check.isString(e) || _.check.isNumber(e) || _.check.isDate(e) || _.check.isBoolean(e) || _.check.isArray(e) || _.check.isObject(e) || Log.w("The format of Data-", t, e, " does not meet the requirements and may not be stored correctly. The attribute value only supports String, Number, Date, Boolean, Array，Object")
                    }), e
                }
            }, {
                ...
                value: function (e) {
                    var r = !0;
                    return _.each(e, function (e, t) {
                        KEY_NAME_MATCH_REGEX.test(t) || (Log.w("invalid key: " + t), r = !1)
                    }), r
                }
            }, {
                key: "event",
                value: function (e) {
                    return !(!_.check.isString(e) || !KEY_NAME_MATCH_REGEX.test(e)) || (Log.w("Please check the parameter format, eventName must be an English letter or a string starting with '_', containing letters and numbers with no more than 50 characters: " + e), !1)
                }
            }, {
                key: "propertyName",
                value: function (e) {
                    return !(!_.check.isString(e) || !KEY_NAME_MATCH_REGEX.test(e)) || (Log.w("Please check the parameter format, propertyName must be an English letter or a string starting with '_', containing letters and numbers with no more than 50 characters: " + e), !1)
                }
            }, {
                key: "properties",
                value: function (e) {
                    return this.stripProperties(e), !e || !(!_.check.isObject(e) || !this._checkPropertiesKey(e) && (Log.w("Please check the parameter format, the key of properties can only start with a letter, contain numbers, letters and underscores _, and the maximum length is 50 characters"), 1))
                }
            }, {
                key: "propertiesMust",
                value: function (e) {
                    return this.stripProperties(e), void 0 === e || !_.check.isObject(e) || _.check.isEmptyObject(e) ? (Log.w("properties must be objects and have values"), !1) : !!this._checkPropertiesKey(e) || (Log.w("Please check the parameter format, the key of properties can only start with a letter, contain numbers, letters and underscores _, and the maximum length is 50 characters"), !1)
                }
            }, {
                key: "userId",
                value: function (e) {
                    return !(!_.check.isString(e) || !/^.{1,63}$/.test(e)) || (Log.w("User id must be a string that cannot be empty and is less than 64 bits"), !1)
                }
            }]), e
        }(),
        ...
        tabStoragePrefix = (TDAnalytics.prototype.trackLink = function (e, r, n) {
            var i, o, s = this;
            this._isCollectData() && (i = this._getConfig("strict"), !PropertyChecker.properties(n) && i ? Log.w("trackLink failed due to invalid properties.") : e && _.check.isObject(e) && (o = [], _.each(e, function (e, r) {
                ...
                var t;
                null !== e && ((t = _.extend({}, _.info.pageProperties(), n))["#element_type"] = e.nodeName.toLowerCase(), _.check.isUndefined(t.name) && (t.name = e.getAttribute("td-name") || e.innerHTML || e.value || "Unable to get Identify"), e.addEventListener("click", function () {
                    s._sendRequest({
                        type: "track",
                        event: r,
            ...
            this._isCollectData() && (PropertyChecker.properties(e) || !this._getConfig("strict") ? _.extend(this.currentProps, e) : Log.w("Page property setting error"))
            ...
            var e = _.info.properties(),
                t = {},
                e = (t.os = e["#os"], t.screenWidth = e["#screen_width"], t.screenHeight = e["#screen_height"], t.browser = e["#browser"], t.browserVersion = e["#browser_version"], t.deviceId = this.getDeviceId(), 0 - (new Date).getTimezoneOffset() / 60);
            ...
            this._isCollectData() && ("number" == typeof e && (e = String(e)), PropertyChecker.userId(e) || !this._getConfig("strict") ? e !== this.persistence.getAccountId() && (this.persistence.setAccountId(e), Log.i("[ThinkingData] Info: Login SDK, AccountId = " + e)) : Log.e("The parameters of the login API must be strings"))
        }, TDAnalytics.prototype.logout = function (e) {
            this._isCollectData() && (!0 === e && (e = _.UUID(), this.persistence.setDistinctId(e)), this.persistence.setAccountId(""), Log.i("[ThinkingData] Info: Logout SDK"))
            ...
            this._isCollectData() && (_.check.isString(e) && (r = e, (e = {})[r] = 1), PropertyChecker.propertiesMust(e)) && (! function (e) {
                ...
                return 1
            }(e) && this._getConfig("strict") ? Log.w("The property value of useradd api must be a number") : this._sendRequest({
                type: "user_add",
                properties: e
            }, t))
            ...
            this._isCollectData() && (PropertyChecker.propertiesMust(e) && function (e) {
                ...
                type: "user_append",
                properties: e
            }, t) : Log.w("The value in the userAppend property can only be Array"))
            ...
            this._isCollectData() && (PropertyChecker.propertiesMust(e) && function (e) {
                ...
                properties: e
            }, t) : Log.w("The value in the userUniqAppend property can only be Array"))
            ...
            var n, i = _.check.isUndefined(e.time) || !_.check.isDate(e.time) ? new Date : e.time,
                o = {
                    data: [{
                        "#type": e.type,
    ...
    function BatchConsumer(e) {
        this.config = e, this.timer = null, this.batchConfig = _.extend({
            ...
            interval: 6e3,
            maxLimit: 500
        }, this.config.batch), this.batchConfig.size < 1 && (this.batchConfig.size = 1), 30 < this.batchConfig.size && (this.batchConfig.size = 30), this.maxLimit = this.batchConfig.maxLimit, this.batchList = [], this.storageKey = storagePrefix + this.config.appId;
        try {
            var t = JSON.parse(_.localStorage.get(this.storageKey));
            _.check.isArray(t) && (this.batchList = t);
            var r = this.config.persistencePrefix + tabStoragePrefix + this.config.appId,
    ...
    BatchConsumer.prototype = {
        ...
        batchWrite: function () {
            this.dataHasChange && (this.dataHasChange = !1, _.localStorage.set(this.storageKey, JSON.stringify(this.batchList)))
        },
        loopSend: function () {
            var e = this;
        ...
        batchSend: function () {
            var e, t, r, n = new Date;
            0 !== this.dataSendTimeStamp && n.getTime() - this.dataSendTimeStamp < this.config.dataSendTimeout + 500 || (this.dataSendTimeStamp = n.getTime(), e = (n = 50 < this.batchList.length ? this.batchList.slice(0, 50) : this.batchList).length, t = this, 0 < e && ((r = {}).data = n, r["#app_id"] = this.config.appId, r["#flush_time"] = (new Date).getTime(), Log.i("[ThinkingData] Debug: Send event, Request ="), Log.i(r), n = JSON.stringify(r), r = _.base64Encode(n), n = "crc=" + _.hashCode(r), r = "&data=" + _.encodeURIComponent(r) + "&ext=" + _.encodeURIComponent(n) + "&version=" + Config.LIB_VERSION, new AjaxTask(r, this.config.serverUrl, 0, function () {
                t.batchRemove(e)
            }, function () {
                t.dataSendTimeStamp = 0
            }, !1, this.config.dataSendTimeout).run()))
        },
        flush: function () {
            clearTimeout(this.timer), this.batchSend(), this.loopSend()
        },
        batchRemove: function (e) {
            this.dataSendTimeStamp = 0, this.batchList.splice(0, e), this.dataHasChange = !0, this.batchWrite(), 0 < this.batchList.length && this.flush()
        }
    };
    var AjaxTask = function () {
        function a(e, t, r, n, i, o, s) {
            _classCallCheck(this, a), this.data = e, this.serverUrl = t, this.tryCount = r || 3, this.success = n, this.error = i, this.isDebug = o, this.dataSendTimeout = s
        }
        return _createClass(a, [{
            key: "run",
            value: function () {
                var t, r = null,
                    n = ((r = window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP")).open("post", this.serverUrl, !0), r.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), this);
                t = setTimeout(function () {
                    ...
                    t && (clearTimeout(t), t = null, n.error && n.error(), r.onreadystatechange = null, r.onload = null, r.onerror = null)
                }, this.dataSendTimeout), r.onreadystatechange = function () {
                    try {
                        var e;
                        4 === r.readyState && (200 <= r.status && r.status < 300 || 304 === r.status ? (n.success && n.success(), t && (clearTimeout(t), t = null), n.isDebug && (0 !== (e = JSON.parse(r.response)).errorLevel ? Log.w(e) : Log.i(e))) : (n.error && n.error(), t && (clearTimeout(t), t = null), 0 < n.tryCount && n.onFailed()))
                    } catch (e) {
                        Log.e(e)
                    }
                }, r.send(this.data)
        ...
        PageLifeCycle = (TDAnalytics.prototype._isDebug = function () {
            ...
            var e = (-1 !== this._getConfig("serverUrl").indexOf("?") ? this._getConfig("serverUrl") : this._getConfig("serverUrl") + "?") + e,
                n = document.createElement("img");
            n.callback = t, this._getConfig("imgUseCrossorigin") && (n.crossOrigin = "anonymous"), setTimeout(r, this._getConfig("dataSendTimeout"), n), n.onload = function () {
            ...
            this._isCollectData() && (_.check.isObject(e) ? (PropertyChecker.event(e.eventName) && PropertyChecker.properties(e.properties) || !this._getConfig("strict")) && this._sendRequest({
                ...
                extraId: e.eventId
            }, e.callback) : Log.e("The parameter of updateble event does not meet the requirements"))
            ...
            this._isCollectData() && (_.check.isObject(e) ? (PropertyChecker.event(e.eventName) && PropertyChecker.properties(e.properties) || !this._getConfig("strict")) && this._sendRequest({
                ...
                properties: e.properties,
                extraId: e.eventId
            }, e.callback) : Log.e("The parameter of overwritable event  does not meet the requirements"))
            ...
            }, e.callback) : Log.e("The parameter of first event does not meet the requirements"))
            ...
            this._isCollectData() && ("number" == typeof e && (e = String(e)), PropertyChecker.userId(e) || !this._getConfig("strict") ? e !== this.persistence.getDistinctId() && (this.persistence.setDistinctId(e), Log.i("[ThinkingData] Info: Setting distinct ID, DistinctId = " + e)) : Log.e("The parameter of setDistinctId API requires a string"))
            ...
            this._isCollectData() && (PropertyChecker.propertiesMust(e) || !this._getConfig("strict") ? this.persistence.setSuperProperties(_.extend({}, this.getSuperProperties(), e)) : Log.w("The paramater of setSuperProperties API requires object"))
            ...
            this._isCollectData() && ("function" == typeof e ? PropertyChecker.properties(e()) || !this._getConfig("strict") ? this.dynamicProperties = e : Log.w("The return value of dynamic properties requires an object") : Log.w("The paramater of setDynamicSuperProperties API requires function type"))
            ...
            var r;
            this._isCollectData() && ("string" == typeof e && "autoTrack" === e ? (r = {}, PropertyChecker.properties(t) && _.extend(r, t), this._sendRequest({
                type: "track",
                event: "ta_pageview",
                properties: _.extend(r, _.info.pageProperties())
            })) : "string" == typeof e && "siteLinker" === e ? siteLinker.init(this, t) : Log.w("The quick method does not support the parameter of" + e))
            ...
            }), void 0 !== this._getConfig("batch") && !1 !== this._getConfig("batch") && _.localStorage.isSupported() && (this.batchConsumer = new BatchConsumer(this.config), this.batchConsumer.batchInterval()), new PageLifeCycle(this, this._getConfig("autoTrack")).start(), t = "normal", this.config.mode && (t = this.config.mode), Log.i("[ThinkingData] Info: TDAnalytics SDK initialize success, AppId = " + this.config.appId + ", ServerUrl = " + this.config.serverUrl + ", Mode = " + t + ", DeviceId = " + this.getDeviceId() + ", Lib = js, LibVersion = " + Config.LIB_VERSION)) : Log.i("The ThinkingData libraray has been initialized.")
        }, function () {
            function r(e, t) {
                _classCallCheck(this, r), this.taLib = e, "Object" === _.paramType(t) && "Boolean" === _.paramType(t.pageShow) ? this.autoPageShow = t.pageShow : this.autoPageShow = !1, "Object" === _.paramType(t) && "Boolean" === _.paramType(t.pageHide) ? this.autoPageHide = t.pageHide : this.autoPageHide = !1
            }
            return _createClass(r, [{
                key: "start",
                value: function () {
                    var e = this;
                    e.trackPageShowEvent(), "onvisibilitychange" in document && _.addEvent(document, "visibilitychange", function () {
        ...
        siteLinker = (TDAnalytics.prototype.initInstance = function (e, t) {
            ...
            _.check.isObject(e) && (e = e.status, Log.i("[ThinkingData] Info: Change Status to " + e), "pause" === e ? this.enableTracking(!1) : "stop" === e ? this.optOutTracking() : "normal" === e && (this.enableTracking(!0), this.optInTracking()))
        }, {}),
        tdMaster;

    function initFromSnippet() {
        var e, t;
        tdMaster && tdMaster.isLoadSDK || (e = window.ThinkingDataAnalyticalTool) && "function" == typeof (tdMaster = window[e]) && ((tdMaster.__SV || 0) < 1.1 ? console.error("Version mismatch; please ensure you're using the latest version of the thinkingdata snippet.") : (tdMaster.isLoadSDK = !0, (t = new TDAnalytics).init(tdMaster.param), tdMaster._q1 && _.check.isArray(tdMaster._q1) && 0 < tdMaster._q1.length && _.each(tdMaster._q1, function (e) {
            t[e[0]].apply(t, slice.call(e[1]))
        }), "function" == typeof t._getConfig("loaded") && t._getConfig("loaded")(t), window[e] = t, tdMaster._q && _.check.isArray(tdMaster._q) && 0 < tdMaster._q.length && _.each(tdMaster._q, function (e) {
            3 === e.length ? t[e[2]][e[0]].apply(t[e[2]], slice.call(e[1])) : t[e[0]].apply(t, slice.call(e[1]))
        })))
    }
    siteLinker.getPartUrl = function (e) {
        ...
        if (t)
            for (var r = 0; r < t; r++)
                if (-1 < e.indexOf(this.option[r].part_url)) return this.option[r].after_hash;
        return !1
        ...
        var r, n, i, o = /([^?#]+)(\?[^#]*)?(#.*)?/.exec(e),
            s = "";
        if (o) return r = o[1] || "", n = o[2] || "", o = o[3] || "", s = this.getPartHash(e) ? (i = o.indexOf("_tasdk"), -1 < o.indexOf("?") ? -1 < i ? r + n + "#" + o.substring(1, i) + "_tasdk=" + this.getCurrenId() : r + n + "#" + o.substring(1) + "&_tasdk=" + this.getCurrenId() : r + n + "#" + o.substring(1) + "?_tasdk=" + this.getCurrenId()) : (i = n.indexOf("_tasdk"), /^\?(\w)+/.test(n) ? -1 < i ? r + "?" + n.substring(1, i) + "_tasdk=" + this.getCurrenId() + o : r + "?" + n.substring(1) + "&_tasdk=" + this.getCurrenId() + o : r + "?" + n.substring(1) + "_tasdk=" + this.getCurrenId() + o), t && (t.href = s), s
    }, siteLinker.addClickListen = function () {
        function e(e) {
            var t, r = (e = e.target).tagName.toLowerCase(),
                n = e.parentNode;
            ("a" === r && e.href || n && n.tagName && "a" === n.tagName.toLowerCase() && n.href) && (r = "a" === r && e.href ? (t = e.href, e) : (t = n.href, n), "http:" !== (e = _.URL(t).protocol) && "https:" !== e || i.getPartUrl(t) && i.rewriteUrl(t, r))
        }
        var i = this;
        ...
        var e, t = this.ta.getDistinctId(),
            r = this.getUrlId();
        return "" !== r && (e = "d" === r.substring(0, 1), (r = r.substring(1)) !== t) && void (r && e && this.ta.setDistinctId(r))
        ...
        this.isInited || (this.isInited = !0, this.ta = e, this.setRefferId(), _.check.isObject(t) && _.check.isArray(t.linker) && 0 < t.linker.length && (this.addClickListen(), this.option = t.linker, this.option = function (e) {
            for (var t = e.length, r = [], n = 0; n < t; n++) /[A-Za-z0-9]+\./.test(e[n].part_url) && "[object Boolean]" === Object.prototype.toString.call(e[n].after_hash) ? r.push(e[n]) : Log.w("The configuration of linker " + (n + 1) + " is not supported.Please check format");
            return r
        }(this.option)))
    }, initFromSnippet()
}();